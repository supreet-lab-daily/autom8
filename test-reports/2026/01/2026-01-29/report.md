...
**Generated:** 2026-01-29T19:34:48.147Z
**Test Run ID:** 707O2000029uEqT
**Workflow Run:** [View Details](https://github.com/supreet-lab-daily/autom8/actions/runs/21491115153)
...
**Error Message:**
```
System.AssertException: Assertion Failed: Account Owner is set to lead Owner: Expected: 005fK000001TKysQAG, Actual: 005O200000TiaecIAB
```
...
**Error Message:**
```
System.AssertException: Assertion Failed: Account Owner manager is set to lead Owner: Expected: 005fK000001TKysQAG, Actual: 005O200000TiaebIAB
```
...
**Error Message:**
```
System.DmlException: Insert failed. First exception on row 0; first error: FIELD_CUSTOM_VALIDATION_EXCEPTION, You can only create Support Team Member records for the teams you are a Lead of (a6eO20000005bIHIAY).: []
```
